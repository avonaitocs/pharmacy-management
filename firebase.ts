// firebase.ts - Updated with environment variables and proper setup
...
export const getOrganizationId = (): string => {
  ...
  if (!orgId) {
    throw new Error('Organization ID not configured. Please set VITE_ORGANIZATION_ID in .env.local');
  }
  return orgId;
};
